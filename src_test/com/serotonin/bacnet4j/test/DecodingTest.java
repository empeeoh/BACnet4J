...
public class DecodingTest {
    public static void main(String[] args) throws Exception {
        ...
        // String input =
        // "81 0b 00 4b 01 a8 ff ff 00 28 3c 06 00 40 ae 00 20 28 ff 81 00 08 30 75 00 00 07 00 ff ff 04 00 23 00 31 00 00 00 00 00 00 00 00 00 00 00 40 ae 00 00 02 04 00 91 01 93 01 46 00 00 00 00 00 0c 00 01 00 06 00 20 29 01 00 00 00";
        // String input =
        // "81 0b 00 4b 01 a8 ff ff 00 28 3c 06 00 40 ae 00 20 28 ff 81 00 08 30 75 00 00 07 00 ff ff 04 00 23 00 31 00 00 00 00 00 00 00 00 00 00 00 40 ae 00 00 02 04 00 00 00 00 00 1e 00 00 00 00 00 0c 00 01 00 06 00 20 29 01 00 00 00";
        // String input =
        // "81 0b 00 45 01 28 ff ff 00 c4 7d 01 04 fd 10 04 09 08 19 01 2e 0c 02 00 75 98 19 00 29 00 3e 0c 00 00 00 65 19 55 3e 44 41 b5 3a 7a 3f 5b 04 00 00 0c 00 80 00 01 19 55 3e 44 41 b4 00 00 3f 5b 04 00 00 3f 2f";
        // String input = "81 0a 00 0d 01 00 50 04 09 91 02 91 2a";

        String s = "810a049a010800140600000000000030030e"
                ...
                + "43139343330324f2a02014e233fffff4f29a84e7508003132332d4445564f2a0" + "3ed4e4f1f";
