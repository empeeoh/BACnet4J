...
//        d.readProperties(rd, refs);
    ...
    public static void test(LocalDevice d) throws Exception {
        ...
        System.out.println(send(d, new ReadPropertyRequest(device, PropertyIdentifier.objectList, new UnsignedInteger(0))));
        System.out.println(send(d, new ReadPropertyRequest(device, PropertyIdentifier.objectList, new UnsignedInteger(1))));
        System.out.println(send(d, new ReadPropertyRequest(device, PropertyIdentifier.objectList, new UnsignedInteger(2))));
        ...
        // Write a value
        System.out.println(send(d, new WritePropertyRequest(created, PropertyIdentifier.presentValue, null, new UnsignedInteger(5), null)));
        System.out.println(send(d, new WritePropertyRequest(created, PropertyIdentifier.presentValue, null, new Real(5.5f), new UnsignedInteger(5))));
        System.out.println(send(d, new WritePropertyRequest(created, PropertyIdentifier.presentValue, new UnsignedInteger(10), new Real(5.5f), null)));
        System.out.println(send(d, new WritePropertyRequest(created, PropertyIdentifier.presentValue, null, new Real(5.5f), null)));
        ...
        System.out.println(send(d, new WritePropertyMultipleRequest(new SequenceOf<WriteAccessSpecification>(writeSpecs))));
...
//        obj.setProperty(new PropertyValue(PropertyIdentifier.objectName, new CharacterString("A cool analog input")));
...
//        specs.add(new ReadAccessSpecification(created, new SequenceOf<PropertyReference>(refs)));
        ...
        criteria.add(new SelectionCriteria(PropertyIdentifier.presentValue, null, RelationSpecifier.notEqual, new Real(0)));
        ObjectSelectionCriteria osc = new ObjectSelectionCriteria(SelectionLogic.or, new SequenceOf<SelectionCriteria>(criteria));
    ...
    public static void test2(LocalDevice d) throws Exception {
        ...
        //System.out.println(send(d, rd, new AddListElementRequest(nc0, PropertyIdentifier.recipientList, new UnsignedInteger(1), dest)));
        System.out.println(send(d, rd, new WritePropertyRequest(nc0, PropertyIdentifier.recipientList, new UnsignedInteger(1), dest, null)));
        ...
        System.out.println(send(d, rd, new ReadPropertyMultipleRequest(new SequenceOf<ReadAccessSpecification>(specs))));
