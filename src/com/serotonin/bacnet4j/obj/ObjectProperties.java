...
public class ObjectProperties {
            ...
            for (Encodable e : seq) {
                if (!def.getClazz().isAssignableFrom(e.getClass()))
                    throw new BACnetServiceException(ErrorClass.property, ErrorCode.invalidDataType,
                            "expected "+ def.getClazz() +", received="+ value.getClass());
            }
        }
    ...
    static {
        ...
        add(ObjectType.accumulator, PropertyIdentifier.objectType, ObjectType.class, false, true, ObjectType.accumulator);
        add(ObjectType.accumulator, PropertyIdentifier.presentValue, UnsignedInteger.class, false, true, new UnsignedInteger(0));
        ...
        add(ObjectType.accumulator, PropertyIdentifier.statusFlags, StatusFlags.class, false, true, new StatusFlags(false, false, false, true));
        ...
        add(ObjectType.accumulator, PropertyIdentifier.units, EngineeringUnits.class, false, true, EngineeringUnits.noUnits);
        ...
        add(ObjectType.accumulator, PropertyIdentifier.limitMonitoringInterval, UnsignedInteger.class, false, false, null);
        ...
        // Analog input
        add(ObjectType.analogInput, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.analogInput, 0x3fffff));
        add(ObjectType.analogInput, PropertyIdentifier.objectName, CharacterString.class, false, true, null);
        add(ObjectType.analogInput, PropertyIdentifier.objectType, ObjectType.class, false, true, ObjectType.analogInput);
        ...
        add(ObjectType.analogInput, PropertyIdentifier.statusFlags, StatusFlags.class, false, true, new StatusFlags(false, false, false, true));
        ...
        add(ObjectType.analogInput, PropertyIdentifier.units, EngineeringUnits.class, false, true, EngineeringUnits.noUnits);
        ...
        // Analog output
        add(ObjectType.analogOutput, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.analogOutput, 0x3fffff));
        add(ObjectType.analogOutput, PropertyIdentifier.objectName, CharacterString.class, false, true, null);
        add(ObjectType.analogOutput, PropertyIdentifier.objectType, ObjectType.class, false, true, ObjectType.analogOutput);
        ...
        add(ObjectType.analogOutput, PropertyIdentifier.statusFlags, StatusFlags.class, false, true, new StatusFlags(false, false, false, true));
        ...
        add(ObjectType.analogOutput, PropertyIdentifier.units, EngineeringUnits.class, false, true, EngineeringUnits.noUnits);
        ...
        // Analog value
        add(ObjectType.analogValue, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.analogValue, 0x3fffff));
        add(ObjectType.analogValue, PropertyIdentifier.objectName, CharacterString.class, false, true, null);
        add(ObjectType.analogValue, PropertyIdentifier.objectType, ObjectType.class, false, true, ObjectType.analogValue);
        ...
        add(ObjectType.analogValue, PropertyIdentifier.statusFlags, StatusFlags.class, false, true, new StatusFlags(false, false, false, true));
        ...
        // Averaging
        add(ObjectType.averaging, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.averaging, 0x3fffff));
        ...
        add(ObjectType.averaging, PropertyIdentifier.attemptedSamples, UnsignedInteger.class, false, true, new UnsignedInteger(0));
        add(ObjectType.averaging, PropertyIdentifier.validSamples, UnsignedInteger.class, false, true, new UnsignedInteger(0));
        add(ObjectType.averaging, PropertyIdentifier.objectPropertyReference, ObjectPropertyReference.class, false, true, null);
        add(ObjectType.averaging, PropertyIdentifier.windowInterval, UnsignedInteger.class, false, true, null);
        add(ObjectType.averaging, PropertyIdentifier.windowSamples, UnsignedInteger.class, false, true, new UnsignedInteger(0));
        add(ObjectType.averaging, PropertyIdentifier.profileName, CharacterString.class, false, false, null);

        
        // Binary input
        add(ObjectType.binaryInput, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.binaryInput, 0x3fffff));
        add(ObjectType.binaryInput, PropertyIdentifier.objectName, CharacterString.class, false, true, null);
        add(ObjectType.binaryInput, PropertyIdentifier.objectType, ObjectType.class, false, true, ObjectType.binaryInput);
        ...
        add(ObjectType.binaryInput, PropertyIdentifier.statusFlags, StatusFlags.class, false, true, new StatusFlags(false, false, false, true));
        ...
        // Binary output
        add(ObjectType.binaryOutput, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.binaryOutput, 0x3fffff));
        add(ObjectType.binaryOutput, PropertyIdentifier.objectName, CharacterString.class, false, true, null);
        add(ObjectType.binaryOutput, PropertyIdentifier.objectType, ObjectType.class, false, true, ObjectType.binaryOutput);
        ...
        add(ObjectType.binaryOutput, PropertyIdentifier.statusFlags, StatusFlags.class, false, true, new StatusFlags(false, false, false, true));
        ...
        add(ObjectType.binaryOutput, PropertyIdentifier.priorityArray, PriorityArray.class, false, true, new PriorityArray());
        add(ObjectType.binaryOutput, PropertyIdentifier.relinquishDefault, BinaryPV.class, false, true, BinaryPV.inactive);
        ...
        // Binary value
        add(ObjectType.binaryValue, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.binaryValue, 0x3fffff));
        add(ObjectType.binaryValue, PropertyIdentifier.objectName, CharacterString.class, false, true, null);
        add(ObjectType.binaryValue, PropertyIdentifier.objectType, ObjectType.class, false, true, ObjectType.binaryValue);
        ...
        add(ObjectType.binaryValue, PropertyIdentifier.statusFlags, StatusFlags.class, false, true, new StatusFlags(false, false, false, true));
        ...
        // Calendar
        add(ObjectType.calendar, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.calendar, 0x3fffff));
        ...
        // Command
        add(ObjectType.command, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.command, 0x3fffff));
        ...
        // Device
        add(ObjectType.device, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.device, 0x3fffff));
        ...
        add(ObjectType.device, PropertyIdentifier.apduSegmentTimeout, UnsignedInteger.class, false, true, new UnsignedInteger(1000));
        add(ObjectType.device, PropertyIdentifier.apduTimeout, UnsignedInteger.class, false, true, new UnsignedInteger(5000));
        add(ObjectType.device, PropertyIdentifier.numberOfApduRetries, UnsignedInteger.class, false, true, new UnsignedInteger(2));
        ...
        add(ObjectType.device, PropertyIdentifier.deviceAddressBinding, AddressBinding.class, true, true, new SequenceOf<AddressBinding>());
        ...
        add(ObjectType.eventEnrollment, PropertyIdentifier.objectPropertyReference, DeviceObjectPropertyReference.class, false, true, null);
        ...
        add(ObjectType.eventEnrollment, PropertyIdentifier.ackedTransitions, EventTransitionBits.class, false, true, null);
        ...
        // File
        add(ObjectType.file, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.file, 0x3fffff));
        ...
        // Group
        add(ObjectType.group, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.group, 0x3fffff));
        ...
        // Life safety point
        add(ObjectType.lifeSafetyPoint, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.lifeSafetyPoint, 0x3fffff));
        ...
        add(ObjectType.lifeSafetyPoint, PropertyIdentifier.lifeSafetyAlarmValues, LifeSafetyState.class, true, false, null);
        ...
        add(ObjectType.lifeSafetyPoint, PropertyIdentifier.ackedTransitions, EventTransitionBits.class, false, false, null);
        ...
        add(ObjectType.lifeSafetyPoint, PropertyIdentifier.operationExpected, LifeSafetyOperation.class, false, true, null);
        ...
        add(ObjectType.lifeSafetyPoint, PropertyIdentifier.units, EngineeringUnits.class, false, true, EngineeringUnits.noUnits);
        ...
        // Life safety zone
        add(ObjectType.lifeSafetyZone, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.lifeSafetyZone, 0x3fffff));
        ...
        add(ObjectType.lifeSafetyZone, PropertyIdentifier.lifeSafetyAlarmValues, LifeSafetyState.class, true, false, null);
        ...
        add(ObjectType.lifeSafetyZone, PropertyIdentifier.ackedTransitions, EventTransitionBits.class, false, false, null);
        ...
        add(ObjectType.lifeSafetyZone, PropertyIdentifier.operationExpected, LifeSafetyOperation.class, false, true, null);
        add(ObjectType.lifeSafetyZone, PropertyIdentifier.maintenanceRequired, Boolean.class, false, false, null);
        ...
        add(ObjectType.loop, PropertyIdentifier.statusFlags, StatusFlags.class, false, true, new StatusFlags(false, false, false, true));
        ...
        add(ObjectType.loop, PropertyIdentifier.manipulatedVariableReference, ObjectPropertyReference.class, false, true, null);
        add(ObjectType.loop, PropertyIdentifier.controlledVariableReference, ObjectPropertyReference.class, false, true, null);
        ...
        // Multi state input
        add(ObjectType.multiStateInput, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.multiStateInput, 0x3fffff));
        add(ObjectType.multiStateInput, PropertyIdentifier.objectName, CharacterString.class, false, true, null);
        add(ObjectType.multiStateInput, PropertyIdentifier.objectType, ObjectType.class, false, true, ObjectType.multiStateInput);
        ...
        add(ObjectType.multiStateInput, PropertyIdentifier.statusFlags, StatusFlags.class, false, true, new StatusFlags(false, false, false, true));
        ...
        add(ObjectType.multiStateInput, PropertyIdentifier.ackedTransitions, EventTransitionBits.class, false, false, null);
        ...
        // Multi state output
        add(ObjectType.multiStateOutput, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.multiStateOutput, 0x3fffff));
        add(ObjectType.multiStateOutput, PropertyIdentifier.objectName, CharacterString.class, false, true, null);
        add(ObjectType.multiStateOutput, PropertyIdentifier.objectType, ObjectType.class, false, true, ObjectType.multiStateOutput);
        add(ObjectType.multiStateOutput, PropertyIdentifier.presentValue, UnsignedInteger.class, false, true, new UnsignedInteger(0));
        ...
        add(ObjectType.multiStateOutput, PropertyIdentifier.statusFlags, StatusFlags.class, false, true, new StatusFlags(false, false, false, true));
        add(ObjectType.multiStateOutput, PropertyIdentifier.eventState, EventState.class, false, true, EventState.normal);
        ...
        add(ObjectType.multiStateOutput, PropertyIdentifier.priorityArray, PriorityArray.class, false, true, new PriorityArray());
        add(ObjectType.multiStateOutput, PropertyIdentifier.relinquishDefault, UnsignedInteger.class, false, true, new UnsignedInteger(0));
        add(ObjectType.multiStateOutput, PropertyIdentifier.timeDelay, UnsignedInteger.class, false, false, null);
        add(ObjectType.multiStateOutput, PropertyIdentifier.notificationClass, UnsignedInteger.class, false, false, null);
        ...
        add(ObjectType.multiStateOutput, PropertyIdentifier.ackedTransitions, EventTransitionBits.class, false, false, null);
        ...
        // Multi state value
        add(ObjectType.multiStateValue, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.multiStateValue, 0x3fffff));
        add(ObjectType.multiStateValue, PropertyIdentifier.objectName, CharacterString.class, false, true, null);
        add(ObjectType.multiStateValue, PropertyIdentifier.objectType, ObjectType.class, false, true, ObjectType.multiStateValue);
        add(ObjectType.multiStateValue, PropertyIdentifier.presentValue, UnsignedInteger.class, false, true, new UnsignedInteger(0));
        add(ObjectType.multiStateValue, PropertyIdentifier.description, CharacterString.class, false, false, null);
        add(ObjectType.multiStateValue, PropertyIdentifier.statusFlags, StatusFlags.class, false, true, new StatusFlags(false, false, false, true));
        ...
        add(ObjectType.multiStateValue, PropertyIdentifier.ackedTransitions, EventTransitionBits.class, false, false, null);
        ...
        // Notification class
        add(ObjectType.notificationClass, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.notificationClass, 0x3fffff));
        add(ObjectType.notificationClass, PropertyIdentifier.objectName, CharacterString.class, false, true, null);
        add(ObjectType.notificationClass, PropertyIdentifier.objectType, ObjectType.class, false, true, ObjectType.notificationClass);
        add(ObjectType.notificationClass, PropertyIdentifier.description, CharacterString.class, false, false, null);
        add(ObjectType.notificationClass, PropertyIdentifier.notificationClass, UnsignedInteger.class, false, true, null);
        ...
        // Program
        add(ObjectType.program, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.program, 0x3fffff));
        ...
        add(ObjectType.program, PropertyIdentifier.statusFlags, StatusFlags.class, false, true, new StatusFlags(false, false, false, true));
        ...
        // Pulse converter
        add(ObjectType.pulseConverter, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.pulseConverter, 0x3fffff));
        add(ObjectType.pulseConverter, PropertyIdentifier.objectName, CharacterString.class, false, true, null);
        add(ObjectType.pulseConverter, PropertyIdentifier.objectType, ObjectType.class, false, true, ObjectType.pulseConverter);
        ...
        add(ObjectType.pulseConverter, PropertyIdentifier.inputReference, ObjectPropertyReference.class, false, false, null);
        add(ObjectType.pulseConverter, PropertyIdentifier.statusFlags, StatusFlags.class, false, true, new StatusFlags(false, false, false, true));
        ...
        add(ObjectType.pulseConverter, PropertyIdentifier.units, EngineeringUnits.class, false, true, EngineeringUnits.noUnits);
        ...
        add(ObjectType.pulseConverter, PropertyIdentifier.ackedTransitions, EventTransitionBits.class, false, false, null);
        ...
        // Trend log
        add(ObjectType.trendLog, PropertyIdentifier.objectIdentifier, ObjectIdentifier.class, false, true, new ObjectIdentifier(ObjectType.trendLog, 0x3fffff));
        ...
        add(ObjectType.trendLog, PropertyIdentifier.covResubscriptionInterval, UnsignedInteger.class, false, false, null);
