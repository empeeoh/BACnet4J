...
public class ComplexACK extends AckAPDU implements Segmentable {
     ...
     * in the present PDU. If the response is present in its entirety, the 'segmented-message' parameter shall be 
     * FALSE. If the present PDU contains only a segment of the response, this parameter shall be TRUE.
     */
     ...
     * then the 'more-follows' parameter shall be TRUE for all segments comprising the confirmed service response 
     * except for the last and shall be FALSE for the final segment. If 'segmented-message' is FALSE, then 
     * 'more-follows' shall be set FALSE by the encoder and shall be ignored by the decoder.
     */
     ...
     * segment of a segmented response. The value of the received 'sequence-number' is used by the original requester 
     * to acknowledge the receipt of one or more segments of a segmented response. The sequence-number of the first 
     * segment of a segmented response shall be zero.
     */
     ...
     * contained in the previous BACnet-Confirmed-Service-Request that has resulted in this acknowledgment. See Clause 
     * 21.
     * 
    ...
    ComplexACK(ByteQueue queue) throws BACnetException {
        byte b = queue.pop();
