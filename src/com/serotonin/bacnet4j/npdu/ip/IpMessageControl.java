...
public class IpMessageControl extends Thread {
    ...
    //    }
    //
    //    public AckAPDU send(String host, Address linkService, int maxAPDULengthAccepted,
    //            Segmentation segmentationSupported, ConfirmedRequestService serviceRequest) throws BACnetException {
    //        return send(host, port, linkService, maxAPDULengthAccepted, segmentationSupported, serviceRequest);
    //    }
    //
    //    public AckAPDU send(String host, int port, Address linkService, int maxAPDULengthAccepted,
    //            Segmentation segmentationSupported, ConfirmedRequestService serviceRequest) throws BACnetException {
    //        return send(new InetSocketAddress(host, port), linkService, maxAPDULengthAccepted, segmentationSupported,
    //                serviceRequest);
    //    }
    //
    //    public AckAPDU send(byte[] host, int port, Address linkService, int maxAPDULengthAccepted,
    //            Segmentation segmentationSupported, ConfirmedRequestService serviceRequest) throws BACnetException {
    //        try {
    //            return send(new InetSocketAddress(InetAddress.getByAddress(host), port), linkService,
    ...
    //    }
    //
    //    public AckAPDU send(InetSocketAddress addr, Address linkService, int maxAPDULengthAccepted,
    //            Segmentation segmentationSupported, ConfirmedRequestService serviceRequest) throws BACnetException {
    //        // Get an invoke id.
    ...
    //
    //            Key key = waitingRoom.enterClient(addr, linkService);
    //            try {
    ...
    //    }
    //
    //    void sendResponse(InetSocketAddress addr, Address linkService, ConfirmedRequest request,
    ...
    //
    //            Key key = waitingRoom.enterServer(addr, linkService, request.getInvokeId());
    //            try {
    ...
    //        else
    //            // We can send the whole APDU in one shot.
    //            sendImpl(new ComplexACK(false, false, request.getInvokeId(), 0, 0, response), false, addr, linkService);
    //    }
    //
    //    private AckAPDU send(Key key, int timeout, APDU[] apdu) throws BACnetException {
    //        byte[][] data = new byte[apdu.length][];
    //        for (int i = 0; i < data.length; i++)
    //            data[i] = createMessageData(apdu[i], false, key.getLinkService());
    //
    ...
    //    }
    //
    //    public void sendUnconfirmed(String host, Address linkService, UnconfirmedRequestService serviceRequest)
    //            throws BACnetException {
    //        sendUnconfirmed(host, port, linkService, serviceRequest);
    //    }
    //
    //    public void sendUnconfirmed(String host, int port, Address linkService, UnconfirmedRequestService serviceRequest)
    //            throws BACnetException {
    //        sendUnconfirmed(new InetSocketAddress(host, port), linkService, serviceRequest);
    //    }
    //
    //    public void sendUnconfirmed(byte[] host, int port, Address linkService, UnconfirmedRequestService serviceRequest)
    //            throws BACnetException {
    //        try {
    //            sendUnconfirmed(new InetSocketAddress(InetAddress.getByAddress(host), port), linkService, serviceRequest);
    //        }
    //        catch (UnknownHostException e) {
    //            throw new BACnetException(e);
    //        }
    //    }
    //
    //    public void sendUnconfirmed(InetSocketAddress addr, Address linkService, UnconfirmedRequestService serviceRequest)
    //            throws BACnetException {
    //        UnconfirmedRequest apdu = new UnconfirmedRequest(serviceRequest);
    //        byte[] data = createMessageData(apdu, false, linkService);
    //        sendImpl(data, addr);
    //    }
    //
    //    public void sendBroadcast(Address linkService, UnconfirmedRequestService serviceRequest) throws BACnetException {
    //        sendBroadcast(port, linkService, serviceRequest);
    //    }
    //
    //    public void sendBroadcast(int port, Address linkService, UnconfirmedRequestService serviceRequest)
    //            throws BACnetException {
    //        UnconfirmedRequest apdu = new UnconfirmedRequest(serviceRequest);
    //        byte[] data = createMessageData(apdu, true, linkService);
    ...
    //    }
    //
    //    void sendImpl(APDU apdu, boolean broadcast, InetSocketAddress addr, Address linkService) throws BACnetException {
    //        sendImpl(createMessageData(apdu, broadcast, linkService), addr);
    //    }
    //
    ...
    //    }
    //
    //    private byte[] createMessageData(APDU apdu, boolean broadcast, Address linkService) {
    ...
    //            len += linkService.getMacAddress().getBytes().length + 4;
    //
    ...
    //        if (linkService != null) {
    //            // Network number
    //            BACnetUtils.pushShort(queue, linkService.getNetworkNumber().intValue());
    //            // Address length
    //            queue.push(linkService.getMacAddress().getBytes().length);
    //            // Address
    //            queue.push(linkService.getMacAddress().getBytes());
    //            // Hop count
    ...
    //            linkServiceAddress = new Address(p.getPort(), p.getAddress().getAddress());
    //        }
    //
    ...
    //                InetSocketAddress from = new InetSocketAddress(linkServiceAddress., linkServicePort);
    ...
    //
    //                waitingRoom.notifyMember(getCachedRemoteInetSocketAddress(fromAddr, fromPort), fromNetwork,
    ...
    //                queue.pop(addr);
    //                linkServiceAddress = new Address(addr, queue.popU2B());
    //            }
    //
    ...
    //                fromAddress = new Address(npci.getSourceNetwork(), npci.getSourceAddress());
    //            else
    //                fromAddress = linkServiceAddress;
    //
    //            // Create the APDU.
    //            try {
